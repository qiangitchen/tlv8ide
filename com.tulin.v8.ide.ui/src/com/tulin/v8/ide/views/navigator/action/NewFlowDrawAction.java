...
import com.tulin.v8.ide.views.navigator.dialog.NewFlowDrawDialog;
			...
			shell.getDisplay().asyncExec(new Runnable() {
				public void run() {
					try {
						...
						try {
							ProcessEditorInput localFileEditorInput2 = new ProcessEditorInput(element);
						...
						Sys.packErrMsg(e.toString());
						showMessage(Messages.getString("View.Action.openfile.3") + element.getSprocessname()
								+ "<processid:" + element.getSprocessid() + Messages.getString("View.Action.openfile.4")
								+ e.toString());
					}
				}
			});
