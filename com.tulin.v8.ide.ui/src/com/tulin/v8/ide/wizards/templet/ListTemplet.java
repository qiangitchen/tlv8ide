...
public class ListTemplet extends TempletsReader {
	/*
	 * 获取页面内容
	 */
	 ...
	 * 获取JS内容
	 */
	public static String getJsContext(String templet, String dbkey, String tableName, String columns, String labels,
			String widths, String datatypes) throws Exception {
