...
public class LeftTreedataPermision extends WizardPage {
	...
	public LeftTreedataPermision() {
		super("lefttreedataPermision");
	}
			...
			public void handleEvent(Event e) {
				if (dbkey == null || "".equals(dbkey)) {
					...
					if (IDialogConstants.OK_ID == result) {
						...
						if (table != null && !"".equals(table) && !table.equals(text2.getText())) {
							cells = null;
							text3.setText("");
						}
						table = text2.getText();
	...
	private void setPageCompleteEnable() {
		boolean enable = (dbkey != null & table != null && ID != null && !"".equals(ID) && parent != null
				&& name != null);
	...
	public IWizardPage getNextPage() {
		return getWizard().getPage("lefttreePageEnd");
	}
