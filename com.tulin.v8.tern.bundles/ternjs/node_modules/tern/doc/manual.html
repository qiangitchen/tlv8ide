...
<p> The <code>cm/tern</code> <em>binary</em> (<a href="http://nodejs.org">node.js</a> script, really),
...
<dt>
<code>--ignore-stdin</code>
</dt>
<dd>
<p>
By default, the server will close when its standard
...
<dt>
<code>inLiteral</code> (optional, default <code>true</code>)
</dt>
<dd>
<p>
If completions should be
...
<p> This plugin, which is enabled by default in the <code>cm/tern</code> server,
...
<p> This plugin (<code>es_modules</code>) builds on top of the
<a href="#plugin_modules"><code>modules</code> plugin</a> to support ECMAScript 6&#8217;s <code>import</code>
and <code>export</code> based module inclusion.</p>
...
are run on them in the editor. <code>loadEagerly</code> allows you to force some
...
<p> The Emacs mode uses the <code>cm/tern</code> server, and project configuration
...
editor.</p>
<h3> <a id="textmate"></a>TextMate</h3>
<p> <a href="https://github.com/fab1an/JavaScript-Tern-Completion.tmbundle">JavaScript Tern Completion.tmbundle</a> integrates Tern with TextMate.</p>
