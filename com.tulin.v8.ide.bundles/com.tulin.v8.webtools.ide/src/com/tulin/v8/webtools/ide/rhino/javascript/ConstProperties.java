...
public interface ConstProperties {
	 ...
	 * to ignore calls to set certain properties, in which case those properties are
	...
	/**
	 * Reserves a definition spot for a const. This will set up a definition of the
	 * const property, but set its value to undefined. The semantics of the start
	 * parameter is the same as for putConst.
	 * 
	 * @param name  The name of the property.
