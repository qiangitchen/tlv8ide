...
public class FunctionObject extends BaseFunction {
	 ...
	 *
	 * <p>
	 * The <code>member</code> argument must be either a java.lang.reflect.Method or
	 * a java.lang.reflect.Constructor and must match one of two forms.
	 * <p>
	 *
	 * The first form is a member with zero or more parameters of the following
	 * types: Object, String, boolean, Scriptable, int, or double. The Long type is
	 * not supported because the double representation of a long (which is the
	 * EMCA-mandated storage type for Numbers) may lose precision. If the member is
	 * a Method, the return value must be void or one of the types allowed for
	 * parameters.
	 * <p>
	 *
	 * The runtime will perform appropriate conversions based upon the type of the
	 * parameter. A parameter type of Object specifies that no conversions are to be
	 * done. A parameter of type String will use Context.toString to convert
	 * arguments. Similarly, parameters of type double, boolean, and Scriptable will
	 * cause Context.toNumber, Context.toBoolean, and Context.toObject,
	 * respectively, to be called.
	 * <p>
	 *
	 * If the method is not static, the Java 'this' value will correspond to the
	 * JavaScript 'this' value. Any attempt to call the function with a 'this' value
	 * that is not of the right Java type will result in an error.
	 * <p>
	 *
	 * The second form is the variable arguments (or "varargs") form. If the
	 * FunctionObject will be used as a constructor, the member must have the
	 ...
	 * constructor, the member must be a static Method with parameters (Context cx,
	 ...
	 * <p>
	 *
	 * When the function varargs form is called as part of a function call, the
	 * <code>args</code> parameter contains the arguments, with <code>thisObj</code>
	 * set to the JavaScript 'this' value. <code>funObj</code> is the function
	 * object for the invoked function.
	 * <p>
	 *
	 * When the constructor varargs form is called or invoked while evaluating a
	 * <code>new</code> expression, <code>args</code> contains the arguments,
	 * <code>ctorObj</code> refers to this FunctionObject, and
	 * <code>inNewExpr</code> is true if and only if a <code>new</code> expression
	 * caused the call. This supports defining a function that has different
	 * behavior when called as a constructor than when invoked as a normal function
	 * call. (For example, the Boolean constructor, when called as a function, will
	 * convert to boolean rather than creating a new object.)
	 * <p>
	 *
	 * @param name                the name of the function
	 * @param methodOrConstructor a java.lang.reflect.Method or a
	 *                            java.lang.reflect.Constructor that defines the
	 *                            object
	 * @param scope               enclosing scope of function
	 * @see com.tulin.v8.webtools.ide.jseditor.rhino.javascript.Scriptable
	 */
		...
		if (arity == 4 && (types[1].isArray() || types[2].isArray())) {
			...
			if (types[1].isArray()) {
				if (!isStatic || types[0] != ScriptRuntime.ContextClass
						...
						|| types[2] != ScriptRuntime.FunctionClass || types[3] != Boolean.TYPE) {
	...
	/**
	 * @return One of <tt>JAVA_*_TYPE</tt> constants to indicate desired type or
	...
	/**
	 * Return the value defined by the method used to construct the object (number
	 * of parameters of the method, or 1 if the method is a "varargs" form).
	 */
	@Override
	public int getArity() {
	 ...
	 * <p>
	 * Sets up the "prototype" and "constructor" properties. Also calls setParent
	 * and setPrototype with appropriate values. Then adds the function object as a
	 * property of the given scope, using <code>prototype.getClassName()</code> as
	 * the name of the property.
	 *
	 * @param scope     the scope in which to define the constructor (typically the
	 *                  global object)
	 * @param prototype the prototype object
	 * @see com.tulin.v8.webtools.ide.jseditor.rhino.javascript.Scriptable#setParentScope
	 * @see com.tulin.v8.webtools.ide.jseditor.rhino.javascript.Scriptable#setPrototype
	 * @see com.tulin.v8.webtools.ide.jseditor.rhino.javascript.Scriptable#getClassName
	 */
	...
	/**
	 * @deprecated Use {@link #getTypeTag(Class)} and
	 *             {@link #convertArg(Context, Scriptable, Object, int)} for type
	 *             conversion.
	 */
	...
	/**
	 * Performs conversions on argument types if needed and invokes the underlying
	 * Java method or constructor.
	 * <p>
	 * Implements Function.call.
	 *
	 * @see com.tulin.v8.webtools.ide.jseditor.rhino.javascript.Function#call( Context,
	...
	/**
	 * Return new {@link Scriptable} instance using the default constructor for the
