...
public class JavaScriptLibraryTable {
	...
	public JavaScriptLibraryTable(final Composite parent) {
		...
		tableViewer.setLabelProvider(new ITableLabelProvider() {
			public Image getColumnImage(Object element, int columnIndex) {
				if (element instanceof File) {
					return WebToolsPlugin.getDefault().getImageRegistry().get(WebToolsPlugin.ICON_JAR_EXT);
				} else if (element instanceof IFile) {
					return WebToolsPlugin.getDefault().getImageRegistry().get(WebToolsPlugin.ICON_JAR);
				}
				return null;
			}
		...
		addExternal.setText(WebToolsPlugin.getResourceString("Button.AddExternal"));
