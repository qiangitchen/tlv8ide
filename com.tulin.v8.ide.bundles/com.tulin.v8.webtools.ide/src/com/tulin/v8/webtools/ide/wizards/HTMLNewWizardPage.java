...
//	private ISelection selection;
	...
	public HTMLNewWizardPage(ISelection selection) {
		...
		setTitle(WebToolsPlugin.getResourceString("HTMLNewWizardPage.Title"));
		setDescription(WebToolsPlugin.getResourceString("HTMLNewWizardPage.Description"));
//		this.selection = selection;
	...
	public void createControl(Composite parent) {
		...
		label.setText(WebToolsPlugin.getResourceString("HTMLNewWizardPage.InputTitle"));
		titleText = new Text(container, SWT.BORDER | SWT.SINGLE);
		titleText.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		
		label = new Label(container, SWT.NULL);
		label.setText(WebToolsPlugin.getResourceString("HTMLNewWizardPage.InputDocType"));
