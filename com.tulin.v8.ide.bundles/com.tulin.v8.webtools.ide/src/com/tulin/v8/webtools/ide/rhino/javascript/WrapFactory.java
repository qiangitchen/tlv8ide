 ...
 * may extend this class and call {@link Context#setWrapFactory(WrapFactory)}
 ...
 * call to a Java method or an access to a Java field.
 *
 * @see com.tulin.v8.webtools.ide.jseditor.rhino.javascript.Context#setWrapFactory(WrapFactory)
 * @since 1.5 Release 4
 */
public class WrapFactory {
	 ...
	 * @param staticType type hint. If security restrictions prevent to wrap object
	...
	/**
	 * Wrap Java object as Scriptable instance to allow full access to its methods
	 * and fields from JavaScript.
	 * <p>
	 * {@link #wrap(Context, Scriptable, Object, Class)} and
	 * {@link #wrapNewObject(Context, Scriptable, Object)} call this method when
	 * they can not convert <tt>javaObject</tt> to JavaScript primitive value or
	 * JavaScript array.
	 * <p>
	 * Subclasses can override the method to provide custom wrappers for Java
	 * objects.
	 * 
	 * @param cx         the current Context for this thread
	 * @param scope      the scope of the executing script
	 ...
	 * <code>Character</code>, should be used directly as JavaScript primitive type.
	 * By default the method returns true to indicate that instances of
	 * <code>String</code>, <code>Number</code>, <code>Boolean</code> and
	 * <code>Character</code> should be wrapped as any other Java object and scripts
	 * can access any Java method available in these objects. Use
	 * {@link #setJavaPrimitiveWrap(boolean)} to change this.
	 */
