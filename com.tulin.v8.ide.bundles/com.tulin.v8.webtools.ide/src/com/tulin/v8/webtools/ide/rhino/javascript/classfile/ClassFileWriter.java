...
package com.tulin.v8.webtools.ide.rhino.javascript.classfile;

import java.io.IOException;
import java.io.OutputStream;

import com.tulin.v8.webtools.ide.rhino.javascript.ObjArray;
import com.tulin.v8.webtools.ide.rhino.javascript.ObjToIntMap;
import com.tulin.v8.webtools.ide.rhino.javascript.UintMap;
...
public class ClassFileWriter {
	 ...
	 *
	 * @param className      the name of the class to write, including full package
	 *                       qualification.
	 * @param superClassName the name of the superclass of the class to write,
	 *                       including full package qualification.
	 * @param sourceFileName the name of the source file to use for producing debug
	 *                       information, or null if debug information is not
	 *                       desired
	 */
	 ...
	 *
	 * This method may be called multiple times for classes that implement multiple
	 * interfaces.
	 *
	 * @param interfaceName a name of an interface implemented by the class being
	 *                      written, including full package qualification.
	 */
	...
	public static final short ACC_PUBLIC = 0x0001, ACC_PRIVATE = 0x0002, ACC_PROTECTED = 0x0004, ACC_STATIC = 0x0008,
			ACC_FINAL = 0x0010, ACC_SYNCHRONIZED = 0x0020, ACC_VOLATILE = 0x0040, ACC_TRANSIENT = 0x0080,
			ACC_NATIVE = 0x0100, ACC_ABSTRACT = 0x0400;

	/**
	 * Set the class's flags.
	 *
	 * Flags must be a set of the following flags, bitwise or'd together: ACC_PUBLIC
	 * ACC_PRIVATE ACC_PROTECTED ACC_FINAL ACC_ABSTRACT TODO: check that this is the
	 * appropriate set
	 * 
	...
	public void addField(String fieldName, String type, short flags, int value) {
		...
		field.setAttributes(itsConstantPool.addUtf8("ConstantValue"), (short) 0, (short) 0,
	...
	public void addField(String fieldName, String type, short flags, long value) {
		...
		short typeIndex = itsConstantPool.addUtf8(type);
		ClassFileField field = new ClassFileField(fieldNameIndex, typeIndex, flags);
		field.setAttributes(itsConstantPool.addUtf8("ConstantValue"), (short) 0, (short) 2,
				itsConstantPool.addConstant(value));
		itsFields.add(field);
	}
	...
	/**
	 * Add Information about java variable to use when generating the local variable
	 * table.
	 *
	 * @param name     variable name.
	 * @param type     variable type as bytecode descriptor string.
	 * @param startPC  the starting bytecode PC where this variable is live, or -1
	 *                 if it does not have a Java register.
	 * @param register the Java register number of variable or -1 if it does not
	 ...
	 *
	 * @param maxLocals the maximum number of local variable slots (a.k.a. Java
	...
	public void add(int theOpCode, int theOperand1, int theOperand2) {
		if (DEBUGCODE) {
			System.out.println("Add " + bytecodeStr(theOpCode) + ", " + Integer.toHexString(theOperand1) + ", "
	...
	public void add(int theOpCode, String className, String fieldName, String fieldType) {
		if (DEBUGCODE) {
			System.out
					.println("Add " + bytecodeStr(theOpCode) + ", " + className + ", " + fieldName + ", " + fieldType);
		}
		int newStack = itsStackTop + stackChange(theOpCode);
	...
	public void addInvoke(int theOpCode, String className, String methodName, String methodType) {
		if (DEBUGCODE) {
			System.out.println(
					"Add " + bytecodeStr(theOpCode) + ", " + className + ", " + methodName + ", " + methodType);
		}
	...
	public void setTableSwitchJump(int switchStart, int caseIndex, int jumpTarget) {
		...
		if (!(0 <= switchStart && switchStart <= itsCodeBufferTop - 4 * 4 - padSize - 1)) {
			throw new IllegalArgumentException(
					switchStart + " is outside a possible range of tableswitch" + " in already generated code");
		}
	...
	public void addExceptionHandler(int startLabel, int endLabel, int handlerLabel, String catchClassName) {
		...
		/*
		 * If catchClassName is null, use 0 for the catch_type_index; which means catch
		 * everything. (Even when the verifier has let you throw something other than a
		 * Throwable.)
		 */
	 ...
	 * not take into account removal of this in case of non-static methods). If Java
	 * really supported references we wouldn't have to be this perverted.
	 */
	...
	/*
	 * Number of bytes of operands generated after the opcode. Not in use currently.
	 */
	/*
	 * int extra(int opcode) { switch (opcode) { case ByteCode.AALOAD: case
	 * ByteCode.AASTORE: case ByteCode.ACONST_NULL: case ByteCode.ALOAD_0: case
	 * ByteCode.ALOAD_1: case ByteCode.ALOAD_2: case ByteCode.ALOAD_3: case
	 * ByteCode.ARETURN: case ByteCode.ARRAYLENGTH: case ByteCode.ASTORE_0: case
	 * ByteCode.ASTORE_1: case ByteCode.ASTORE_2: case ByteCode.ASTORE_3: case
	 * ByteCode.ATHROW: case ByteCode.BALOAD: case ByteCode.BASTORE: case
	 * ByteCode.BREAKPOINT: case ByteCode.CALOAD: case ByteCode.CASTORE: case
	 * ByteCode.D2F: case ByteCode.D2I: case ByteCode.D2L: case ByteCode.DADD: case
	 * ByteCode.DALOAD: case ByteCode.DASTORE: case ByteCode.DCMPG: case
	 * ByteCode.DCMPL: case ByteCode.DCONST_0: case ByteCode.DCONST_1: case
	 * ByteCode.DDIV: case ByteCode.DLOAD_0: case ByteCode.DLOAD_1: case
	 * ByteCode.DLOAD_2: case ByteCode.DLOAD_3: case ByteCode.DMUL: case
	 * ByteCode.DNEG: case ByteCode.DREM: case ByteCode.DRETURN: case
	 * ByteCode.DSTORE_0: case ByteCode.DSTORE_1: case ByteCode.DSTORE_2: case
	 * ByteCode.DSTORE_3: case ByteCode.DSUB: case ByteCode.DUP2: case
	 * ByteCode.DUP2_X1: case ByteCode.DUP2_X2: case ByteCode.DUP: case
	 * ByteCode.DUP_X1: case ByteCode.DUP_X2: case ByteCode.F2D: case ByteCode.F2I:
	 * case ByteCode.F2L: case ByteCode.FADD: case ByteCode.FALOAD: case
	 * ByteCode.FASTORE: case ByteCode.FCMPG: case ByteCode.FCMPL: case
	 * ByteCode.FCONST_0: case ByteCode.FCONST_1: case ByteCode.FCONST_2: case
	 * ByteCode.FDIV: case ByteCode.FLOAD_0: case ByteCode.FLOAD_1: case
	 * ByteCode.FLOAD_2: case ByteCode.FLOAD_3: case ByteCode.FMUL: case
	 * ByteCode.FNEG: case ByteCode.FREM: case ByteCode.FRETURN: case
	 * ByteCode.FSTORE_0: case ByteCode.FSTORE_1: case ByteCode.FSTORE_2: case
	 * ByteCode.FSTORE_3: case ByteCode.FSUB: case ByteCode.I2B: case ByteCode.I2C:
	 * case ByteCode.I2D: case ByteCode.I2F: case ByteCode.I2L: case ByteCode.I2S:
	 * case ByteCode.IADD: case ByteCode.IALOAD: case ByteCode.IAND: case
	 * ByteCode.IASTORE: case ByteCode.ICONST_0: case ByteCode.ICONST_1: case
	 * ByteCode.ICONST_2: case ByteCode.ICONST_3: case ByteCode.ICONST_4: case
	 * ByteCode.ICONST_5: case ByteCode.ICONST_M1: case ByteCode.IDIV: case
	 * ByteCode.ILOAD_0: case ByteCode.ILOAD_1: case ByteCode.ILOAD_2: case
	 * ByteCode.ILOAD_3: case ByteCode.IMPDEP1: case ByteCode.IMPDEP2: case
	 * ByteCode.IMUL: case ByteCode.INEG: case ByteCode.IOR: case ByteCode.IREM:
	 * case ByteCode.IRETURN: case ByteCode.ISHL: case ByteCode.ISHR: case
	 * ByteCode.ISTORE_0: case ByteCode.ISTORE_1: case ByteCode.ISTORE_2: case
	 * ByteCode.ISTORE_3: case ByteCode.ISUB: case ByteCode.IUSHR: case
	 * ByteCode.IXOR: case ByteCode.L2D: case ByteCode.L2F: case ByteCode.L2I: case
	 * ByteCode.LADD: case ByteCode.LALOAD: case ByteCode.LAND: case
	 * ByteCode.LASTORE: case ByteCode.LCMP: case ByteCode.LCONST_0: case
	 * ByteCode.LCONST_1: case ByteCode.LDIV: case ByteCode.LLOAD_0: case
	 * ByteCode.LLOAD_1: case ByteCode.LLOAD_2: case ByteCode.LLOAD_3: case
	 * ByteCode.LMUL: case ByteCode.LNEG: case ByteCode.LOR: case ByteCode.LREM:
	 * case ByteCode.LRETURN: case ByteCode.LSHL: case ByteCode.LSHR: case
	 * ByteCode.LSTORE_0: case ByteCode.LSTORE_1: case ByteCode.LSTORE_2: case
	 * ByteCode.LSTORE_3: case ByteCode.LSUB: case ByteCode.LUSHR: case
	 * ByteCode.LXOR: case ByteCode.MONITORENTER: case ByteCode.MONITOREXIT: case
	 * ByteCode.NOP: case ByteCode.POP2: case ByteCode.POP: case ByteCode.RETURN:
	 * case ByteCode.SALOAD: case ByteCode.SASTORE: case ByteCode.SWAP: case
	 * ByteCode.WIDE: return 0;
	 * 
	 * case ByteCode.ALOAD: case ByteCode.ASTORE: case ByteCode.BIPUSH: case
	 * ByteCode.DLOAD: case ByteCode.DSTORE: case ByteCode.FLOAD: case
	 * ByteCode.FSTORE: case ByteCode.ILOAD: case ByteCode.ISTORE: case
	 * ByteCode.LDC: case ByteCode.LLOAD: case ByteCode.LSTORE: case
	 * ByteCode.NEWARRAY: case ByteCode.RET: return 1;
	 * 
	 * case ByteCode.ANEWARRAY: case ByteCode.CHECKCAST: case ByteCode.GETFIELD:
	 * case ByteCode.GETSTATIC: case ByteCode.GOTO: case ByteCode.IFEQ: case
	 * ByteCode.IFGE: case ByteCode.IFGT: case ByteCode.IFLE: case ByteCode.IFLT:
	 * case ByteCode.IFNE: case ByteCode.IFNONNULL: case ByteCode.IFNULL: case
	 * ByteCode.IF_ACMPEQ: case ByteCode.IF_ACMPNE: case ByteCode.IF_ICMPEQ: case
	 * ByteCode.IF_ICMPGE: case ByteCode.IF_ICMPGT: case ByteCode.IF_ICMPLE: case
	 * ByteCode.IF_ICMPLT: case ByteCode.IF_ICMPNE: case ByteCode.IINC: case
	 * ByteCode.INSTANCEOF: case ByteCode.INVOKEINTERFACE: case
	 * ByteCode.INVOKESPECIAL: case ByteCode.INVOKESTATIC: case
	 * ByteCode.INVOKEVIRTUAL: case ByteCode.JSR: case ByteCode.LDC2_W: case
	 * ByteCode.LDC_W: case ByteCode.NEW: case ByteCode.PUTFIELD: case
	 * ByteCode.PUTSTATIC: case ByteCode.SIPUSH: return 2;
	 * 
	 * case ByteCode.MULTIANEWARRAY: return 3;
	 * 
	 * case ByteCode.GOTO_W: case ByteCode.JSR_W: return 4;
	 * 
	 * case ByteCode.LOOKUPSWITCH: // depends on alignment case
	 * ByteCode.TABLESWITCH: // depends on alignment return -1; } throw new
	 * IllegalArgumentException("Bad opcode: "+opcode); }
	 */
...
final class ConstantPool {
	...
	private static final byte CONSTANT_Class = 7, CONSTANT_Fieldref = 9, CONSTANT_Methodref = 10,
			CONSTANT_InterfaceMethodref = 11, CONSTANT_String = 8, CONSTANT_Integer = 3, CONSTANT_Float = 4,
			CONSTANT_Long = 5, CONSTANT_Double = 6, CONSTANT_NameAndType = 12, CONSTANT_Utf8 = 1;
