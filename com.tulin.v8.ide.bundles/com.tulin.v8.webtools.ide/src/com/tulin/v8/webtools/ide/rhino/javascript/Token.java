...
public class Token {
	...
	ERROR = -1, // well-known as the only code < EOF
			...
			ENTERWITH = 2, LEAVEWITH = 3, RETURN = 4, GOTO = 5, IFEQ = 6, IFNE = 7, SETNAME = 8, BITOR = 9, BITXOR = 10,
			BITAND = 11, EQ = 12, NE = 13, LT = 14, LE = 15, GT = 16, GE = 17, LSH = 18, RSH = 19, URSH = 20, ADD = 21,
			SUB = 22, MUL = 23, DIV = 24, MOD = 25, NOT = 26, BITNOT = 27, POS = 28, NEG = 29, NEW = 30, DELPROP = 31,
			TYPEOF = 32, GETPROP = 33, GETPROPNOWARN = 34, SETPROP = 35, GETELEM = 36, SETELEM = 37, CALL = 38,
			NAME = 39, NUMBER = 40, STRING = 41, NULL = 42, THIS = 43, FALSE = 44, TRUE = 45, SHEQ = 46, // shallow
																											// equality
																											// (===)
			SHNE = 47, // shallow inequality (!==)
			REGEXP = 48, BINDNAME = 49, THROW = 50, RETHROW = 51, // rethrow caught exception: catch (e if ) use it
			IN = 52, INSTANCEOF = 53, LOCAL_LOAD = 54, GETVAR = 55, SETVAR = 56, CATCH_SCOPE = 57, ENUM_INIT_KEYS = 58,
			ENUM_INIT_VALUES = 59, ENUM_INIT_ARRAY = 60, ENUM_NEXT = 61, ENUM_ID = 62, THISFN = 63, RETURN_RESULT = 64, // to
																														// return
																														// previously
																														// stored
																														// return
			...
			ESCXMLATTR = 74, ESCXMLTEXT = 75, REF_MEMBER = 76, // Reference for x.@y, x..y etc.
	...
	public final static int FIRST_ASSIGN = ASSIGN, LAST_ASSIGN = ASSIGN_MOD,
			...
			LABEL = 129, // label
			TARGET = 130, LOOP = 131, EXPR_VOID = 132, // expression statement in functions
			...
			CONST = 153, SETCONST = 154, SETCONSTVAR = 155, ARRAYCOMP = 156, // array comprehension
			LETEXPR = 157, WITHEXPR = 158, DEBUGGER = 159, LAST_TOKEN = 159;

	// MODIFIED BY AMATERAS
	public final static int OBJPROP = 201;
	public final static int COMMENT = 211;
	public final static int JSDOC = 212;
