...
public interface Evaluator {
	...
	/**
	 * Compile the script or function from intermediate representation tree into an
	 * executable form.
	 *
	 ...
	 * 
	 * @param cx    Context
	 * @param linep Array object of length >= 1; getSourcePositionFromStack will
	 *              assign the line number to linep[0].
	...
	/**
	 * Mark the given script to indicate it was created by a call to eval() or to a
