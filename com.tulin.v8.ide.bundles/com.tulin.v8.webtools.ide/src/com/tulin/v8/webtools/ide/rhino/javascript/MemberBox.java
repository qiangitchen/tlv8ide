 ...
 * getParameterTypes() results, recover from IllegalAccessException in some
 * cases and provide serialization support.
 *
 */
final class MemberBox implements Serializable {
	 ...
	 * information about the class, the name, and the parameters and recreate upon
	 * deserialization.
	 */
	...
	private static final Class<?>[] primitives = { Boolean.TYPE, Byte.TYPE, Character.TYPE, Double.TYPE, Float.TYPE,
			Integer.TYPE, Long.TYPE, Short.TYPE, Void.TYPE };

	/**
	 * Writes an array of parameter types to the stream.
	 *
	 * Requires special handling because primitive types cannot be found upon
	 * deserialization by the default Java implementation.
	 */
