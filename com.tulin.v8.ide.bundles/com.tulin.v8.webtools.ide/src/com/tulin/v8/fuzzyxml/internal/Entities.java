 ...
 * 
 * <p>
 * <strong>Note:</strong> This class came from
 * <a href="http://jakarta.apache.org/commons/lang/">Jakarta Commons Lang</a>,
 * and applied small patches for standalone using. The original source code is
 * <a href=
 * "http://svn.apache.org/viewcvs.cgi/jakarta/commons/proper/lang/trunk/src/java/org/apache/commons/lang/Entities.java?rev=209978&view=markup">here</a>.
 * </p>
 * 
 * @see <a href=
...
// <!-- rsaquo is proposed but not yet ISO standardized -->
	...
	static class LookupEntityMap extends PrimitiveEntityMap {
		...
		/**
		 * <p>
		 * Returns the lookup table for this entity map. The lookup table is created if
		...
		/**
		 * <p>
		 * Creates an entity lookup table of LOOKUP_TABLE_SIZE elements, initialized
		 * with entity names.
		 * </p>
		 */
	...
	static class ArrayEntityMap implements EntityMap {
		...
		/**
		 * Constructs a new instance of <code>ArrayEntityMap</code> specifying the size
		 * by which the array should grow.
		 * 
	...
	static class BinaryEntityMap extends ArrayEntityMap {
		...
		/**
		 * Constructs a new instance of <code>ArrayEntityMap</code> specifying the size
		 * by which the underlying array should grow.
		 * 
		 * @param growBy array will be initialized to and will grow by this amount
		 */
		...
		/**
		 * Performs a binary search of the entity array for the specified key. This
		 * method is based on code in {@link java.util.Arrays}.
		 * 
	 ...
	 * </p>
	 * 
	 * @param writer The <code>Writer</code> to write the results of the escaping
	 ...
	 * </p>
	 * 
	 * @param writer The <code>Writer</code> to write the results to; assumed to be
	 *               non-null.
	 * @param string The <code>String</code> to write the results to; assumed to be
	 *               non-null.
	 * @throws IOException when <code>Writer</code> passed throws the exception from
	 *                     calls to the {@link Writer#write(int)} methods.
	 * 
