  ...
  function Parser() {
    ...
    this.get_content = function () { //function to capture regular content between tags
      ...
      while (this.input.charAt(this.pos) !== '<') {
        ...
        content.push(c); //letter at-a-time (or string) inserted to an array
      }
    ...
    this.get_tag = function () { //function to get a full tag and parse its type
      ...
      do {
        ...
        if (this.Utils.in_array(c, this.Utils.whitespace)) { //don't want to insert unnecessary space
          space = true;
          this.line_char_count--;
          continue;
        }
        ...
        if (c === "'" || c === '"') {
          if (!content[1] || content[1] !== '!') { //if we're in a comment strings don't get treated specially
            c += this.get_unformatted(c);
            space = true;
          }
        }
        
        if (c === '=') { //no space before =
          space = false;
        }
        
        if (content.length && content[content.length-1] !== '=' && c !== '>'
        ...
        content.push(c); //inserts character at-a-time (or string)
      } while (c !== '>');
