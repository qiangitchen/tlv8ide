...
public class TomcatSourcePathPreferencePage extends PreferencePage implements
	...
	protected Control createContents(Composite parent) {
		...
		projectListEditor.setCheckedElements(TomcatLauncherPlugin.getDefault()
	...
	public boolean performOk() {
		...
		TomcatLauncherPlugin.getDefault().setProjectsInSourcePath(
