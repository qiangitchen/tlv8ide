...
public class ListFieldEditor extends ListEditor implements
	...
	protected String getNewInputObject() {
		...
		InputDialog dialog = new InputDialog(getShell(),
				"New Tomcat JVM paramater", "Enter a JVM parameter",
				defaultValue, null);
		String param = null;
	...
	protected String[] parseString(String stringList) {
		StringTokenizer st = new StringTokenizer(stringList,
				TomcatPluginResources.PREF_PAGE_LIST_SEPARATOR); //$NON-NLS-1$
