...
import com.tulin.v8.flowdesigner.ui.editors.process.dialog.ExpressionEditorDialog;
import com.tulin.v8.flowdesigner.ui.editors.process.dialog.FunctionTreeDialog;
import com.tulin.v8.flowdesigner.ui.editors.process.dialog.PersonsSelectionDialog;
...
import com.tulin.v8.flowdesigner.ui.editors.process.element.NodePropertySet;
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if ("selectexePage".equals(property.getButton())) {
					FunctionTreeDialog dialog = new FunctionTreeDialog(TuLinPlugin.getShell());
					...
					PersonsSelectionDialog dialog = new PersonsSelectionDialog(TuLinPlugin.getShell());
					...
					ExpressionEditorDialog dialog = new ExpressionEditorDialog(TuLinPlugin.getShell(),
							property.getValue());
					int state = dialog.open();
					if (state == IDialogConstants.OK_ID) {
