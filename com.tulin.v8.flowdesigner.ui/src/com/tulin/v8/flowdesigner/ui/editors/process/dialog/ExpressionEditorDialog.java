...
import com.tulin.v8.flowdesigner.ui.editors.process.ExpressionTreeHelper;
...
public class ExpressionEditorDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		containertopl.setText(Messages.getString("TLEditor.ExpressionEdit.fnlist"));
		...
		containerrtop.setText(Messages.getString("TLEditor.ExpressionEdit.params"));
		paramtable = new Table(containerrtop, SWT.FILL | SWT.BORDER | SWT.V_SCROLL | SWT.FULL_SELECTION);
		...
		containerrbot.setText(Messages.getString("TLEditor.ExpressionEdit.helps"));
		helptext = new Text(containerrbot,
				SWT.BORDER | SWT.LEFT | SWT.READ_ONLY | SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL);
		...
		ToolBar ltoolbar = new ToolBar(sashbottom, SWT.FLAT | SWT.WRAP | SWT.RIGHT | SWT.BAR);
		...
		reduceItem.setText(Messages.getString("TLEditor.ExpressionEdit.reduce"));
		reduceItem.setData("-");
		...
		exceptItem.setText(Messages.getString("TLEditor.ExpressionEdit.except"));
		exceptItem.setData("/");
		...
		ToolBar rtoolbar = new ToolBar(sashbottom, SWT.FLAT | SWT.WRAP | SWT.RIGHT | SWT.BAR);
		...
		addToolItem.setToolTipText(Messages.getString("TLEditor.ExpressionEdit.add"));
		addToolItem.setImage(TuLinPlugin.getIcon("addbtn.gif"));
		...
		delToolItem.setToolTipText(Messages.getString("TLEditor.ExpressionEdit.del"));
		delToolItem.setImage(TuLinPlugin.getIcon("delbtn.gif"));
		...
		chkToolItem.setImage(TuLinPlugin.getIcon("checkvalidity.gif"));

		expText = new Text(sashbottom, SWT.BORDER | SWT.MULTI | SWT.WRAP | SWT.LEFT | SWT.V_SCROLL);
	...
	private void readElement(Element ele, TreeItem treeitem) {
		...
		if (!eles.isEmpty()) {
			...
			treeitem.setImage(TuLinPlugin.getIcon("file.gif"));
		}
	}
