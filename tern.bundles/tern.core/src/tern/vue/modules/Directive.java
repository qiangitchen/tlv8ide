 ...
 * Vue directive.
 */
public class Directive extends VueElement {
	...
	public Directive(String name, VueType type, String url, Collection<String> tagNames, String restrict,
	...
	public Directive(String name, VueType type, String url, Collection<String> tagNames, String restrict,
		...
		super(name, VueType.directive, start, end, file, parent);
		this.type = type;
		this.url = url;
	...
	public VueType getDirectiveType() {
		return type;
	}
}
