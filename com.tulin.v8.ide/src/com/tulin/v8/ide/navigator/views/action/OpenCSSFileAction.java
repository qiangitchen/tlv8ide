...
public class OpenCSSFileAction extends Action implements Runnable {
	TreeViewer viewer;

	public OpenCSSFileAction(TreeViewer viewer) {
		this.viewer = viewer;
		setText(Messages.getString("View.Action.openfile.1"));
		setText(Messages.getString("View.Action.openfile.2"));
