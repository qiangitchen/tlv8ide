...
public class OpenFnFileAction extends Action implements Runnable {
	TreeViewer viewer;

	public OpenFnFileAction(TreeViewer viewer) {
		this.viewer = viewer;
		setText(Messages.getString("View.Action.openfile.7"));
		setText(Messages.getString("View.Action.openfile.8"));
				...
				try {
					...
					try {
						FileEditorInput localFileEditorInput2 = new FileEditorInput(
								iFile);
						IDE.openEditor(page, localFileEditorInput2, FnEditor.ID);
					} catch (Exception e) {
