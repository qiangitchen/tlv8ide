...
public class OpenJSFileAction extends Action implements Runnable {
	TreeViewer viewer;

	public OpenJSFileAction(TreeViewer viewer) {
		this.viewer = viewer;
		setText(Messages.getString("View.Action.openfile.17"));
		setText(Messages.getString("View.Action.openfile.18"));
