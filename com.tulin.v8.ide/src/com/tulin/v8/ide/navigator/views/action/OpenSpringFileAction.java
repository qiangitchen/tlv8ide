...
import com.tulin.v8.ide.ui.editors.spring.SpringConfigEditor;

import zigen.plugin.db.ui.internal.TreeNode;

public class OpenSpringFileAction extends Action implements Runnable {
	TreeViewer viewer;

	public OpenSpringFileAction(TreeViewer viewer) {
		this.viewer = viewer;
		setText(Messages.getString("editor.name.spring"));
