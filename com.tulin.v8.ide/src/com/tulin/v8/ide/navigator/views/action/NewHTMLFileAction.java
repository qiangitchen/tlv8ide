...
public class NewHTMLFileAction extends Action implements Runnable {
	TreeViewer viewer = null;

	public NewHTMLFileAction(TreeViewer viewer) {
		this.viewer = viewer;
		setText(Messages.getString("View.Action.NewFile.4"));
	...
	public void run() {
		...
		NewFileWizard wizard = new NewFileWizard(viewer, "html");
