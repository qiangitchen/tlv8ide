...
public class OpenJavaFileAction extends Action implements Runnable {
	TreeViewer viewer;

	public OpenJavaFileAction(TreeViewer viewer) {
		this.viewer = viewer;
		setText(Messages.getString("View.Action.openfile.15"));
		setText(Messages.getString("View.Action.openfile.16"));
