...
public class OpenTxtFileAction extends Action implements Runnable {
	TreeViewer viewer;

	public OpenTxtFileAction(TreeViewer viewer) {
		this.viewer = viewer;
		setText(Messages.getString("View.Action.openfile.21"));
		setText(Messages.getString("View.Action.openfile.22"));
