...
public class OpenHTMLFileAction extends Action implements Runnable {
	TreeViewer viewer;

	public OpenHTMLFileAction(TreeViewer viewer) {
		this.viewer = viewer;
		setText(Messages.getString("View.Action.openfile.13"));
		setText(Messages.getString("View.Action.openfile.14"));
