...
public class OpenPageFileAction extends Action implements Runnable {
	TreeViewer viewer;

	public OpenPageFileAction(TreeViewer viewer) {
		this.viewer = viewer;
		setText(Messages.getString("View.Action.openfile.25"));
		setText(Messages.getString("View.Action.openfile.26"));
