...
public class OpenFunctionTreeFileAction extends Action implements Runnable {
	TreeViewer viewer;

	public OpenFunctionTreeFileAction(TreeViewer viewer) {
		this.viewer = viewer;
		setText(Messages.getString("View.Action.openfile.11"));
		setText(Messages.getString("View.Action.openfile.12"));
