...
class DataConversion {
	...
	public Image getImage(String path) {
		if (path != null && !"".equals(path)) {
			...
			return StudioPlugin.getIcon("folder-open.gif");
		}
	}
	...
	public Element addRootItem() {
		...
		rootItem.setAttribute("label",
				Messages.getString("editors.FunEditor.rootEle"));
	...
	public Element addChildItem(Element parentItem) {
		...
		childItem.setAttribute("label",
				Messages.getString("editors.FunEditor.subEle"));
