...
import com.tulin.v8.ide.ui.editors.function.dialog.SelectFunctionDialog;
...
public class FunctionEditor extends MultiPageEditorPart implements IResourceChangeListener {
	public static String ID = "com.tulin.v8.ide.ui.editors.func.FunctionEditor";
	...
	private void makeActions() {
		...
		addrootAction.setImageDescriptor(ImageDescriptor.createFromImage(StudioPlugin.getIcon("add.gif")));
		...
		addchildAction.setImageDescriptor(ImageDescriptor.createFromImage(StudioPlugin.getIcon("add.gif")));
		...
		deleteAction.setImageDescriptor(ImageDescriptor.createFromImage(StudioPlugin.getIcon("delete.gif")));
	}
	...
	void createPage1() {
		...
		addchild.setImage(StudioPlugin.getIcon("addbtn.gif"));
