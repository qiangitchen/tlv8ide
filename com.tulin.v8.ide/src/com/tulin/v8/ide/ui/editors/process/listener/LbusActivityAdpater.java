...
public class LbusActivityAdpater extends SelectionAdapter {
	FlowDesignEditor processeditor;

	public LbusActivityAdpater(FlowDesignEditor processeditor) {
		this.processeditor = processeditor;
	}

	public void widgetSelected(SelectionEvent paramSelectionEvent) {
		this.processeditor.callJsFunction("MenuAction.nodeRect();");
	}
}
