...
import com.tulin.v8.ide.ui.editors.echt.action.RefreshAction;
import com.tulin.v8.ide.ui.editors.echt.call.GetScriptCallJava;
import com.tulin.v8.ide.ui.editors.echt.call.GetThemeCallJava;
import com.tulin.v8.ide.ui.editors.echt.call.LoadSourceCallJava;
...
public class EchartsDesignPage extends FormPage {
	...
	public void loadBrowser() {
		try {
			String basecUrl = StudioConfig.getStudioAppRootPath() + "/chartsnewizard/chartpreview/";
			String sourceUrl = "chartsmodle.html";
			String designUrl = WebServer.getDefaultWebServer().getResourcePathURL(basecUrl, sourceUrl);
