...
import com.tulin.v8.ide.ui.editors.process.action.CatAction;
import com.tulin.v8.ide.ui.editors.process.action.CopyAction;
import com.tulin.v8.ide.ui.editors.process.action.DeleteAction;
import com.tulin.v8.ide.ui.editors.process.action.PasteAction;
import com.tulin.v8.ide.ui.editors.process.call.CallJava;
import com.tulin.v8.ide.ui.editors.process.call.DataInitedCallJava;
import com.tulin.v8.ide.ui.editors.process.call.DesignChangeCallJava;
import com.tulin.v8.ide.ui.editors.process.call.SelectedCallJava;
import com.tulin.v8.ide.ui.editors.process.element.ConditionPropertys;
...
import com.tulin.v8.ide.ui.editors.process.element.LinePropertys;
import com.tulin.v8.ide.ui.editors.process.element.NodeOvalPropertys;
import com.tulin.v8.ide.ui.editors.process.element.NodePropertys;
import com.tulin.v8.ide.ui.editors.process.element.ProcessDrawElement;
import com.tulin.v8.ide.ui.editors.process.listener.BrowserProgressListener;
import com.tulin.v8.ide.ui.editors.process.listener.LEndAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LForkAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LLineAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LPolineAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LSWDownAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LSWLeftAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LSWRightAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LSWUpAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LSelectAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LSetLockkAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LStartAdpater;
import com.tulin.v8.ide.ui.editors.process.listener.LbusActivityAdpater;
import com.tulin.v8.ide.utils.IDUtils;
...
public class FlowDesignEditor extends EditorPart {
	...
	public void createPartControl(Composite parent) {
		...
		localToolItem1.setImage(StudioPlugin.getIcon("process_icons/select.gif"));
		...
		localToolItem2.setImage(StudioPlugin.getIcon("process_icons/start.png"));
		...
		localToolItem3.setImage(StudioPlugin.getIcon("process_icons/end.png"));
		...
		localToolItem4.setImage(StudioPlugin.getIcon("process_icons/biz.png"));
		...
		localToolItem7.setImage(StudioPlugin.getIcon("process_icons/fork.png"));
		...
		localToolItem10.setImage(StudioPlugin.getIcon("process_icons/forward.gif"));
		...
		localToolItem101.setImage(StudioPlugin.getIcon("process_icons/transition.png"));
		...
		localToolItem11.setImage(StudioPlugin.getIcon("process_icons/down.png"));
		...
		lockitem.setImage(StudioPlugin.getIcon("process_icons/lock.gif"));
	...
	private Menu createEditPopup() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				...
				select.setImageDescriptor(StudioPlugin.getImageDescriptor("icons/process_icons/select.gif"));
				manager.add(select);
				...
				addstart.setImageDescriptor(StudioPlugin.getImageDescriptor("icons/process_icons/start.png"));
				...
				addactivity.setImageDescriptor(StudioPlugin.getImageDescriptor("icons/process_icons/biz.png"));
				...
				addafork.setImageDescriptor(StudioPlugin.getImageDescriptor("icons/process_icons/fork.png"));
				...
				addend.setImageDescriptor(StudioPlugin.getImageDescriptor("icons/process_icons/end.png"));
				openmenu.add(addend);
				...
				linkline.setImageDescriptor(StudioPlugin.getImageDescriptor("icons/process_icons/forward.gif"));
				...
				linkpoline.setImageDescriptor(StudioPlugin.getImageDescriptor("icons/process_icons/transition.png"));
