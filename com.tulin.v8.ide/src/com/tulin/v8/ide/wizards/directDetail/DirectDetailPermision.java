...
public class DirectDetailPermision extends WizardPage {
	...
	public DirectDetailPermision() {
		super("directDetailPermision");
	}
	...
	public void createControl(Composite parent) {
		...
		setTitle(Messages.getString("wizards.dataselect.message.datasettings"));
			...
			public void handleEvent(Event e) {
				if (dbkey == null || "".equals(dbkey)) {
					MessageDialog.openError(getShell(), Messages.getString("wizards.dataselect.message.errtitle"),
							Messages.getString("wizards.dataselect.message.errSelectDatasource"));
				} else {
	...
	public IWizardPage getNextPage() {
		return getWizard().getPage("directDetailPageEnd");
	}
