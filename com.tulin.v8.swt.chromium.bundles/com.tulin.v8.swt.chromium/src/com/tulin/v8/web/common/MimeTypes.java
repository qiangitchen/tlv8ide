...
public class MimeTypes {
	...
	static {
		synchronized (extensionToMimeTypeMap) {
			...
			extensionToMimeTypeMap.put("docx",
			...
			extensionToMimeTypeMap.put("dotx",
			...
			extensionToMimeTypeMap.put("potx,",
			...
			extensionToMimeTypeMap.put("ppsx",
			...
			extensionToMimeTypeMap.put("pptx",
