...
import zigen.plugin.db.ui.editors.internal.wizard.CheckWizard;
import zigen.plugin.db.ui.internal.ITable;

public class AddCheckAction extends TableViewEditorAction {

	public AddCheckAction() {
		this.setText(Messages.getString("AddCheckAction.0")); //$NON-NLS-1$
		this.setToolTipText(Messages.getString("AddCheckAction.1")); //$NON-NLS-1$
	}
	...
	public void run() {
		...
		CheckWizard wizard = new CheckWizard(factory, tableNode);
