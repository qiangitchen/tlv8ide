...
class W3cDocumentHelper {
	...
	public static List getChildXmlElementList(Element paramElement, String paramString) {
		NodeList localNodeList = paramElement.getChildNodes();
		ArrayList localArrayList = new ArrayList();
		for (int i = 0; i < localNodeList.getLength(); i++) {
			Node localNode = localNodeList.item(i);
			if ((localNode.getNodeType() != 1) || (!getLocalName(localNode).equals(paramString)))
				continue;
	...
	public static String asXML(Element paramElement, List paramList, boolean paramBoolean) {
		StringBuffer localStringBuffer = new StringBuffer();
		a(paramElement, localStringBuffer, paramList, paramBoolean, paramBoolean);
		return localStringBuffer.toString();
	}

	public static String asXML(Element paramElement, List paramList, boolean paramBoolean1, boolean paramBoolean2) {
		StringBuffer localStringBuffer = new StringBuffer();
		a(paramElement, localStringBuffer, paramList, paramBoolean1, paramBoolean2);
		return localStringBuffer.toString();
	}

	private static void a(Element paramElement, StringBuffer paramStringBuffer, List paramList, boolean paramBoolean1,
		...
		while (((Iterator) localObject2).hasNext()) {
			...
			if (((paramList != null) && (paramList.contains(((Attr) localObject3).getName())))
			...
			str3 = str3.replaceAll("<", "&lt;");
			str3 = str3.replaceAll(">", "&gt;");
			paramStringBuffer.append(((Attr) localObject3).getName() + "=\"" + str3 + "\" ");
		}
		...
		for (int i = 0; i < ((NodeList) localObject2).getLength(); i++) {
			...
			if ((((Node) localObject4).getNodeType() != 1) && (((Node) localObject4).getNodeType() != 3)
		...
		if (((List) localObject3).size() == 0) {
			...
			while (((Iterator) localObject4).hasNext()) {
				...
				if (localNode.getNodeType() == 1) {
					...
					a((Element) localNode, paramStringBuffer, paramList, paramBoolean1, paramBoolean2);
				} else if ((localNode.getNodeType() == 3) || (localNode.getNodeType() == 4)) {
					String str4 = localNode.getNodeValue();
					if ((str4 != null) && (!str4.trim().equals("")))
						if ((!str4.startsWith("<![CDATA[")) && (localNode.getNodeType() == 4)) {
							if (i == 0)
	...
	public static Attr createAttribute(Element paramElement, String paramString1, String paramString2) {
		...
		Attr localAttr = paramElement.getOwnerDocument().createAttribute(paramString1);
	...
	protected static String getValueForTextContent(List paramList) {
		...
		if (paramList.size() > 0) {
			if ((paramList.get(0) instanceof org.apache.xerces.dom.TextImpl)) {
				TextImpl localObject = (org.apache.xerces.dom.TextImpl) paramList.get(0);
				return ((org.apache.xerces.dom.TextImpl) localObject).getTextContent();
			}
		}
		return str;
	}

	public static Element getFirstChildXmlElementByTag(Element paramElement, String paramString) {
		NodeList localNodeList = paramElement.getChildNodes();
		for (int i = 0; i < localNodeList.getLength(); i++) {
			Node localNode = localNodeList.item(i);
			if ((localNode.getNodeType() == 1) && (paramString.equals(getLocalName(localNode))))
				return (Element) localNode;
		}
		return null;
	}

	public static Element getFirstChildXmlElementByAttr(Element paramElement, String paramString1, String paramString2,
			String paramString3, String paramString4) {
		NodeList localNodeList = paramElement.getChildNodes();
		for (int i = 0; i < localNodeList.getLength(); i++) {
			Node localNode = localNodeList.item(i);
			if ((localNode.getNodeType() != 1) || (!getLocalName(localNode).equals(paramString1)))
				continue;
			Element localElement = (Element) localNode;
			String str = localElement.getAttributeNS(paramString2, paramString3);
	...
	public static void setFullText(Element paramElement, String paramString, boolean paramBoolean) {
		NodeList localNodeList = paramElement.getChildNodes();
		int i = 0;
		int j = localNodeList.getLength();
		while (i < j) {
		...
		if (paramBoolean)
			paramElement.appendChild(paramElement.getOwnerDocument().createCDATASection(paramString));
		else
			paramElement.appendChild(paramElement.getOwnerDocument().createTextNode(paramString));
	}
	...
	public static Attr getAttributeByName(Element paramElement, String paramString) {
		NamedNodeMap localNamedNodeMap = paramElement.getAttributes();
		for (int i = 0; i < localNamedNodeMap.getLength(); i++) {
			Node localNode = localNamedNodeMap.item(i);
			if (localNode.getNodeType() != 2)
	...
	public static Attr getAttributeByLocalName(Element paramElement, String paramString) {
		NamedNodeMap localNamedNodeMap = paramElement.getAttributes();
		for (int i = 0; i < localNamedNodeMap.getLength(); i++) {
			Node localNode = localNamedNodeMap.item(i);
			if (localNode.getNodeType() != 2)
	...
	public static String getAttrVlueByLocalName(Element paramElement, String paramString) {
		NamedNodeMap localNamedNodeMap = paramElement.getAttributes();
		for (int i = 0; i < localNamedNodeMap.getLength(); i++) {
			Node localNode = localNamedNodeMap.item(i);
			if (localNode.getNodeType() != 2)
	...
	public static void setElementText(Element paramElement, String paramString) {
		...
		if (localList != null) {
			...
			if ((paramString != null) && (paramString.startsWith("<![CDATA["))) {
				...
				paramElement.appendChild(localDocument.createCDATASection(paramString));
			} else {
				if (paramString != null)
					paramString = paramString.replace("<", "&lt;").replace(">", "&gt;");
	...
	public static void setElementAttr(Element paramElement, String paramString1, String paramString2) {
	...
	protected static void setValueForTextContent(List paramList, String paramString) {
		if (paramList.size() > 0) {
			Object localObject1 = paramList.get(0);
			Object localObject2;
			if ((localObject1 instanceof org.apache.xerces.dom.TextImpl)) {
				localObject2 = (org.apache.xerces.dom.TextImpl) localObject1;
				((org.apache.xerces.dom.TextImpl) localObject2).setTextContent(paramString);
			}
		}
	}
	...
	private static List<Node> a(Element paramElement) {
		...
		for (Node localNode = paramElement.getFirstChild(); localNode != null; localNode = localNode.getNextSibling())
			if ((localNode.getNodeType() == 3) || (localNode.getNodeType() == 5) || (localNode.getNodeType() == 4)) {
				if (localVector == null)
	...
	public static Document readFileAsXML(String paramString) {
		...
		try {
			...
			Document localDocument1 = localDocumentBuilder.parse(new FileInputStream(paramString));
	...
	public static Document StrToXML(String paramString) throws Exception {
		...
		DocumentBuilderFactory localDocumentBuilderFactory = DocumentBuilderFactory.newInstance();
		localDocumentBuilder = localDocumentBuilderFactory.newDocumentBuilder();
		Document localDocument1 = localDocumentBuilder.parse(new ByteArrayInputStream(paramString.getBytes("UTF-8")));
		return localDocument1;
	}
