...
public class GridCheckDialogLayoutPage extends WizardPage {
	...
	public GridCheckDialogLayoutPage(DataSelectPage Page) {
		super("gridCheckDialogPageLayout");
		setTitle("列表多选对话框");
		setDescription("配置列表多选对话框详细参数.");
		dataSelectPage = Page;
	}
	...
	public IWizardPage getNextPage() {
		...
		setMessage(Messages.getString("wizardsaction.dataselect.message.delectedDatasource") + dbkey
				...
				+ keyField + ".");
		return getWizard().getPage("gridCheckDialogPageEnd");
	}
