...
public class UReportPreview extends FormPage {
	...
	public void createPartControl(Composite parent) {
		...
		if (swtbrowser != null) {
			...
			new SWTLoadReport(meditor, swtbrowser, "callLoadReport");
			new org.eclipse.swt.browser.BrowserFunction(swtbrowser, "callPreviewReport") {
				@Override
			...
			new SWTSaveReportFile(meditor, swtbrowser, "callSaveReportFile");
			new SWTImportExcelReportFile(meditor, swtbrowser, "importExcelReportFile");
		...
		if (browser != null && "chromium".equalsIgnoreCase(browser.getBrowserType())) {
