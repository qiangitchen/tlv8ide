...
public class DataBaseSQLParse {
	...
	public static void transeData(Element baseData, Parameters parameter) throws Exception {
	...
	public static void handleSQLElement(Element baseData, Element sqlEl, Parameters parameter) throws Exception {
	...
	public static List execQueryforList(String key, String sql, Parameters parameter) throws SQLException, NamingException {
		ResultSet rs = null;
