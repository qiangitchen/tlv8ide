...
public class SampleDetailTemplet extends TempletsReader {
	/*
	 * 获取页面内容
	 */
	public static String getPageContext(String filename, StringArray columns, StringArray labels, StringArray datatypes,
			boolean iscreateinfo) throws Exception {
		String context = iscreateinfo ? getTempletPageContext("simpleDetail", "acpage.html")
				: getTempletPageContext("simpleDetail");
	 ...
	 * 获取JS内容
	 */
	public static String getJsContext(String dbkey, String tableName, boolean iscreateinfo) throws Exception {
		String context = iscreateinfo ? getTempletJsContext("simpleDetail", "acpage.js")
				: getTempletJsContext("simpleDetail");
