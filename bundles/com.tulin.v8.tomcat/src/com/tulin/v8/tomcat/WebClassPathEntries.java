...
public class WebClassPathEntries {
	...
	/**
	 * instantiate a WebClassPathEntries object and intialize it with the xml
	 * data provided
	 * 
	...
	public static void main(String[] arguments) {
		...
		if (!entries.getWebClassPathEntry(0).equals("abc")) {
			System.err.println("expected 'abc' but was '"
					+ entries.getWebClassPathEntry(0) + "'");
			System.exit(1);
		}
		...
		if (!entries.getWebClassPathEntry(1).equals("def")) {
			System.err.println("expected 'def' but was '"
					+ entries.getWebClassPathEntry(1) + "'");
			System.exit(1);
		}
		if (!entries.getWebClassPathEntry(2).equals("123")) {
			System.err.println("expected '123' but was '"
					+ entries.getWebClassPathEntry(2) + "'");
			System.exit(1);
		}
