...
public interface TomcatPluginResources {
	...
	static final String PREF_PAGE_SET_LABEL = 
		TomcatLauncherPlugin.getResourceString("pref.page.choosesetting.label");
	
	static final String PREF_PAGE_DEFAULTSET_LABEL = 
		TomcatLauncherPlugin.getResourceString("pref.page.defaultset.label");

	static final String PREF_PAGE_MYSELFSET_LABEL = 
		TomcatLauncherPlugin.getResourceString("pref.page.myselfset.label");
	...
	static final String PREF_PAGE_VERSION8_LABEL = 
			TomcatLauncherPlugin.getResourceString("pref.page.version8.label");
	
	static final String PREF_PAGE_VERSION9_LABEL = 
			TomcatLauncherPlugin.getResourceString("pref.page.version9.label");
	
	static final String PREF_PAGE_VERSION10_LABEL = 
			TomcatLauncherPlugin.getResourceString("pref.page.version10.label");
	
	static final String PREF_PAGE_VERSION11_LABEL = 
			TomcatLauncherPlugin.getResourceString("pref.page.version11.label");
