...
public class ReadHTML {
	...
	public static Image getImageByTagName(String tagName) {
		...
		if ("script".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/brkp_obj.gif");
		if ("link".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/css_prop.gif");
		if ("form".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/form.gif");
		if ("meta".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/static.gif");
		if ("title".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/unknown.gif");
		if ("button".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/button.gif");
		if ("table".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/tables.png");
		if ("a".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/link.gif");
		if ("label".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tag.gif");
		if ("textarea".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/textarea.gif");
		if ("select".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/select.gif");
		if ("checkbox".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/checkbox.gif");
		if ("radio".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/radio.gif");
		...
		if ("input[text]".equals(tagName.toLowerCase()))
			return TuLinPlugin.getIcon("tags/text.gif");
