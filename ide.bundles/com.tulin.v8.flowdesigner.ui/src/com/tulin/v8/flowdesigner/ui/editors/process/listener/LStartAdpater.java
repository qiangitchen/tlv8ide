...
public class LStartAdpater extends SelectionAdapter {
	FlowDesignEditor processeditor;

	public LStartAdpater(FlowDesignEditor processeditor) {
		this.processeditor = processeditor;
	}

	public void widgetSelected(SelectionEvent paramSelectionEvent) {
		this.processeditor.callJsFunction("MenuAction.start();");
	}
}
