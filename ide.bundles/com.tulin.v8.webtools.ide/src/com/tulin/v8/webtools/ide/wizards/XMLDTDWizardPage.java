...
public class XMLDTDWizardPage extends WizardPage {
	...
	public XMLDTDWizardPage(String pageName, XMLNewWizardPage page1) {
		super(pageName);
		setTitle(WebToolsPlugin.getResourceString("XMLDTDWizardPage.Title"));
		setDescription(WebToolsPlugin.getResourceString("XMLDTDWizardPage.Description"));
		this.page1 = page1;
	}
	...
	public void createControl(Composite parent) {
		...
		radioNone.setText(WebToolsPlugin.getResourceString("XMLDTDWizardPage.NoSchema"));
		...
		radioDTD.setText(WebToolsPlugin.getResourceString("XMLDTDWizardPage.UseDID"));
		...
		radioXSD.setText(WebToolsPlugin.getResourceString("XMLDTDWizardPage.UseXSD"));
		...
		label.setText(WebToolsPlugin.getResourceString("XMLDTDWizardPage.PublicID"));
		...
		label.setText(WebToolsPlugin.getResourceString("XMLDTDWizardPage.SystemID"));
		...
		label = new Label(composite, SWT.NULL);
		label.setText(WebToolsPlugin.getResourceString("XMLDTDWizardPage.XMLSchema"));
		...
		buttonLoadDTD.setText(WebToolsPlugin.getResourceString("XMLDTDWizardPage.LoadDTD"));
...
//						}
		...
		label = new Label(composite, SWT.NULL);
		label.setText(WebToolsPlugin.getResourceString("XMLDTDWizardPage.DocumentRoot"));
			...
			if (getPublicID().equals("")) {
				setMessage(
						WebToolsPlugin.createMessage(WebToolsPlugin.getResourceString("Error.Required"),
								new String[] { WebToolsPlugin.getResourceString("XMLDTDWizardPage.Message.PublicID") }),
						DialogPage.ERROR);
				return false;
			} else if (getSystemID().equals("")) {
				setMessage(
						WebToolsPlugin.createMessage(WebToolsPlugin.getResourceString("Error.Required"),
								new String[] { WebToolsPlugin.getResourceString("XMLDTDWizardPage.Message.SystemID") }),
						DialogPage.ERROR);
				return false;
				...
				setMessage(
						WebToolsPlugin.createMessage(WebToolsPlugin.getResourceString("Error.Required"),
								new String[] {
										WebToolsPlugin.getResourceString("XMLDTDWizardPage.Message.DocumentRoot") }),
						DialogPage.ERROR);
				return false;
			}
		}
		if (getUseXSD()) {
			if (getSchemaURI().equals("")) {
				setMessage(
						WebToolsPlugin.createMessage(WebToolsPlugin.getResourceString("Error.Required"),
								new String[] {
										WebToolsPlugin.getResourceString("XMLDTDWizardPage.Message.XMLSchema") }),
						DialogPage.ERROR);
				return false;
			} else if (getDocumentRoot().equals("")) {
				setMessage(
