...
public class Kit {
	/**
	 * Reflection of Throwable.initCause(Throwable) from JDK 1.4 or nul if it is not
	 * available.
	 */
	...
	/**
	 * If initCause methods exists in Throwable, call <tt>ex.initCause(cause)</tt>
	...
	/**
	 * If character <tt>c</tt> is a hexadecimal digit, return <tt>accumulator</tt> *
	 * 16 plus corresponding number. Otherise return -1.
	 */
	...
	/**
	 * Add <i>listener</i> to <i>bag</i> of listeners. The function does not modify
	 * <i>bag</i> and return a new collection containing <i>listener</i> and all
	 * listeners from <i>bag</i>. Bag without listeners always represented as the
	 * null value.
	 * <p>
	 * Usage example:
	 * 
	...
	/**
	 * Remove <i>listener</i> from <i>bag</i> of listeners. The function does not
	 * modify <i>bag</i> and return a new collection containing all listeners from
	 * <i>bag</i> except <i>listener</i>. If <i>bag</i> does not contain
	 * <i>listener</i>, the function returns <i>bag</i>.
	 * <p>
	...
	/**
	 * Get listener at <i>index</i> position in <i>bag</i> or null if <i>index</i>
	 * equals to number of listeners in <i>bag</i>.
	 * <p>
	 * For usage example, see {@link #addListener(Object bag, Object listener)}.
	 *
	 * @param bag   Current collection of listeners.
