...
package com.tulin.v8.webtools.ide.rhino.javascript.xml;

import com.tulin.v8.webtools.ide.rhino.javascript.Context;
import com.tulin.v8.webtools.ide.rhino.javascript.IdScriptableObject;
import com.tulin.v8.webtools.ide.rhino.javascript.NativeWith;
import com.tulin.v8.webtools.ide.rhino.javascript.Ref;
...
public abstract class XMLObject extends IdScriptableObject {
	...
	/**
	 * Return an additional object to look for methods that runtime should consider
	 * during method search. Return null if no such object available.
	 */
	...
	/**
	 * Custom <tt>+</tt> operator. Should return {@link Scriptable#NOT_FOUND} if
	 * this object does not have custom addition operator for the given value, or
	 * the result of the addition operation.
	 * <p>
	 * The default implementation returns {@link Scriptable#NOT_FOUND} to indicate
	 * no custom addition operation.
	 *
	 * @param cx         the Context object associated with the current thread.
	 * @param thisIsLeft if true, the object should calculate this + value if false,
