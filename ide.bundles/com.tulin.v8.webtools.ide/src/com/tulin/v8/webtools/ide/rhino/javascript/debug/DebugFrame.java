...
package com.tulin.v8.webtools.ide.rhino.javascript.debug;
...
public interface DebugFrame {
	...
	/**
	 * Called when execution is ready to start bytecode interpretation for entered a
	 * particular function or script.
	 * 
	 ...
	 * 
	 * @param cx                current Context for this thread
	 * @param byThrow           if true function will leave by throwing exception,
	 *                          otherwise it will execute normal return
