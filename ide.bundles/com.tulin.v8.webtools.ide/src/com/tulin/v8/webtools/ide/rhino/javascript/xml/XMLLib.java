...
import com.tulin.v8.webtools.ide.rhino.javascript.ScriptRuntime;
import com.tulin.v8.webtools.ide.rhino.javascript.Scriptable;
import com.tulin.v8.webtools.ide.rhino.javascript.ScriptableObject;
...
public abstract class XMLLib {
	 ...
	 * certainly more flexible) to write an interface that returns an XMLLib object
	 * rather than a class name, for example. But that would cause many more ripple
	 * effects in the code, all the way back to {@link ScriptRuntime}.
	 */
