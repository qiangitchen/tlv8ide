...
public interface ErrorReporter {
	 ...
	 * @param sourceName a String describing the JavaScript source where the warning
	 ...
	 * @param sourceName a String describing the JavaScript source where the error
	 *                   occured; typically a filename or URL
