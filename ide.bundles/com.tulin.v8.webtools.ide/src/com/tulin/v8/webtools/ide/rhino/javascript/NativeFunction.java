...
public abstract class NativeFunction extends BaseFunction {
	...
	/**
	 * @deprecated Use {@link BaseFunction#getFunctionName()} instead. For backwards
	 *             compatibility keep an old method name used by Batik and possibly
	 *             others.
	 */
	...
	/**
	 * Get parameter or variable name. If <tt>index < {@link #getParamCount()}</tt>,
	 * then return the name of the corresponding parameter. Otherwise return the
	 * name of variable.
	 */
	 ...
	 * <tt>index < {@link #getParamCount()}</tt>, then return the const-ness of the
	 * corresponding parameter. Otherwise return whether the variable is const.
	 */
