...
public abstract class RhinoException extends RuntimeException {
	 ...
	 *
	 * @param sourceName the uri of the script source responsible for the error. It
	 ...
	 *
	 * @param lineNumber the line number in the script source. It should be positive
	 *                   number.
	 *
	 * @throws IllegalStateException if the method is called more then once.
	 */
	 ...
	 *
	 * @param columnNumber the column number in the script source. It should be
	 *                     positive number.
	 *
	 * @throws IllegalStateException if the method is called more then once.
	 */
	 ...
	 *
	 * @param lineSource the text of the source line responsible for the error. It
	 *                   should not be <tt>null</tt>.
	 *
	 * @throws IllegalStateException if the method is called more then once.
	 */
	...
	/**
	 * Get a string representing the script stack of this exception. If optimization
	 * is enabled, this corresponds to all java stack elements with a source name
	 * ending with ".js".
	 * 
	 ...
	 * Get a string representing the script stack of this exception. If optimization
	 * is enabled, this corresponds to all java stack elements with a source name
	 * matching the <code>filter</code>.
	 * 
	 * @param filter the file name filter to determine whether a file is a script
	 *               file
	 * @return a script stack dump
	 * @since 1.6R6
	 */
	public String getScriptStackTrace(FilenameFilter filter) {
		...
		for (int i = 0; i < stack.length; i++) {
			...
			} else if (interpreterStack != null && interpreterStack.size() > interpreterStackIndex
					&& "com.tulin.v8.webtools.ide.jseditor.rhino.javascript.Interpreter".equals(e.getClassName())
