...
import com.tulin.v8.markdown.pagemodel.MarkdownFormatter;
import com.tulin.v8.markdown.pagemodel.MarkdownPage;
import com.tulin.v8.markdown.pagemodel.MarkdownPage.KLineType;
...
public class FormatAction extends Action implements IHandler {
	...
	public FormatAction() {
		...
		setActionDefinitionId("com.tulin.v8.markdown.formatParagraphCommand");
