...
public class ReportParser {
	...
	public ReportDefinition parse(String filetext, String file) {
		try {
			Document document = DocumentHelper.parseText(filetext);
	...
	public ReportDefinition parse(Document document, String file) {
	...
	private void rebuild(ReportDefinition report) {
		...
		for (CellDefinition cell : cells) {
			...
			int rowNum = cell.getRowNumber(), colNum = cell.getColumnNumber(), rowSpan = cell.getRowSpan(),
