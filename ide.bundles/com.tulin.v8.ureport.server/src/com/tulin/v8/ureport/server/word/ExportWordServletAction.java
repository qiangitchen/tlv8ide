...
public class ExportWordServletAction extends RenderPageServletAction {
	...
	public ExportWordServletAction(HTTPRequest httpRequest) {
		super(httpRequest);
	...
	public WebServerContent buildWord() {
		...
		try {
			...
			if (file.equals(PREVIEW_KEY)) {
				...
				wordProducer.produce(report, out);
			} else {
		...
		return new WordWebServerContent(out);
	}
