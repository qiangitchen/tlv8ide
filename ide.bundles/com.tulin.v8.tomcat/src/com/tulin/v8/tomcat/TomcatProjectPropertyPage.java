...
/**
 * provides a tab control with property pages for the settings of a tomcat
 * project.
 * 
 * @version 1.0
 * @author Martin Kahr
 */
public class TomcatProjectPropertyPage extends PropertyPage implements
	...
	protected Control createContents(Composite parent) {
		...
		generalTab
				.setText(TomcatPluginResources.PROPERTIES_PAGE_PROJECT_GENERAL_TAB_LABEL);
		generalTab.setControl(generalPropertyPage.createContents(folder));

		// webclasspath property page
		webClassPathPropertyPage = new TomcatProjectWebclasspathPropertyPage(
				this);
		// add to tab
		TabItem webClassTab = new TabItem(folder, SWT.NONE);
		webClassTab
				.setText(TomcatPluginResources.PROPERTIES_PAGE_PROJECT_DEVLOADER_TAB_LABEL);
