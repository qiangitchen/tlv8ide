...
public class TomcatManagerAppPreferencePage extends FieldEditorPreferencePage
	...
	protected void createFieldEditors() {
		...
		urlEditor = new StringFieldEditor(
				...
				PREF_PAGE_MANAGER_URL, getFieldEditorParent());
	...
	public void addUserToTomcatUsers() {
		try {
			...
			File tomcatUsersFile = new File(tomcatDir + File.separator + "conf"
					+ File.separator + "tomcat-users.xml");
			String tomcatUsersContent = FileUtil.readTextFile(tomcatUsersFile);
			String before = tomcatUsersContent.substring(0,
					tomcatUsersContent.indexOf(endTag));
