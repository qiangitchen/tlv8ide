...
public class MobileSampleDeatailPage extends WizardPage {
	...
	public MobileSampleDeatailPage(DataSelectPage Page) {
		super("mobilesampleDeatailPage");
		setTitle("单表详细");
		setDescription("请选择数据源.");
		dataSelectPage = Page;
	}
	...
	public IWizardPage getNextPage() {
		...
		return getWizard().getPage("mobilesampleDeatailEnd");
	}
